package com.wangyh.crm.aspect;

import com.wangyh.crm.annoation.RequiredPermission;
import com.wangyh.crm.exceptions.AuthException;
...
public class PermissionProxy {
    ...
    /**
     * 切面会拦截指定包下的指定注解
     *      拦截com.wangyh.crm.annoation的RequiredPermission注解
     *
     * @param pjp
     * @return java.lang.Object
     */
    @Around(value = "@annotation(com.wangyh.crm.annoation.RequiredPermission)")
