...
import com.wangyh.crm.utils.Md5Util;
import com.wangyh.crm.utils.PhoneUtil;
import com.wangyh.crm.utils.UserIDBase64;
...
//        userModel.setUserId(user.getId());
    ...
    public void updateSetting(User user) {
        System.out.println("111111111"+user.getId());
        // 判断用户ID是否为空，且数据存在
     ...
     *  如何进行角色分配？？？
     *      上述操作解决方法：判断用户对应的角色记录存在，先将用户原有的角色记录删除，再添加新的角色记录
     *  删除操作
     *      删除指定用户绑定的角色记录
     *
     * @param userId  用户ID
